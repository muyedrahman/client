...
const Navbar = () => {
  ...
  // active link style
  const navLinkClass = ({ isActive }) =>
    `font-semibold transition-colors duration-200 hover:text-red-600 whitespace-nowrap ${
      isActive ? "text-red-600" : "text-gray-700 dark:text-gray-200"
    }`;
    ...
    >
      <Container>
        <div className="flex items-center justify-between h-16 gap-2">
          ...
          {/* CENTER: Desktop Links — switches at lg (1024px) instead of md (768px)
              so tablets (768–1024px) don't get a cramped layout */}
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            ...
            {/* LOGGED IN: Profile Dropdown — desktop only (lg+) */}
            {user ? (
              ...
              /* LOGGED OUT: Login + Signup — desktop only (lg+) */
              <div className="hidden lg:flex items-center gap-2">
                <Link
                  ...
                  className="px-4 py-2 rounded-xl text-sm font-semibold 
                             text-red-600 border border-red-200 
                             hover:bg-red-50 dark:hover:bg-red-900/20 
                             dark:text-red-400 dark:border-red-800 transition-colors whitespace-nowrap"
                >
                  Login
                </Link>
                <Link
                  ...
                  className="px-4 py-2 rounded-xl text-sm font-semibold 
                             text-white bg-red-600 hover:bg-red-700 
                             transition-colors shadow-sm shadow-red-200 whitespace-nowrap"
                >
                  Sign Up
                </Link>
              </div>
            ...
            {/* HAMBURGER: shows up to lg (covers mobile + tablet) */}
            <button
              onClick={() => setIsOpen(!isOpen)}
      ...
      {/* MOBILE/TABLET MENU (dropdown panel) — shows below lg */}
      <div
