...
const FeaturedSection = () => {
  const features = [
    {
      icon: <Heart className="w-12 h-12 text-red-500 dark:text-red-400" />,
      title: "Why Donate Blood?",
      desc: "One bag of blood can save up to three lives. Your donation can give someone a new lease on life.",
    },
    {
      icon: (
        <ShieldCheck className="w-12 h-12 text-red-500 dark:text-red-400" />
      ),
    ...
    {
      icon: <Users className="w-12 h-12 text-red-500 dark:text-red-400" />,
  ...
  return (
    <div className="py-20 bg-white dark:bg-gray-950 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="mt-3 text-center text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
          Learn about the importance of blood donation and the safe process —
          everything is easy and accessible on our platform.
        </p>
